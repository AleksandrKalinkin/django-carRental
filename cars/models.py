...
#     price = models.Decimal(max_digits=5, decimal_places=2) #5- так как у меня цена тачки за сутки максимум 30000.00 будет, 2 - так как.00
#     cateqory = models.ForeignKey(CarsCategory, on_delete= models.PROTECT)#внешний ключ из таблицы
